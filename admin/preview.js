...
var BASE_CSS = [
  ...
  '.preview-wrap { min-height:100vh; background:#000; color:#fff; }',
  /* Homepage */
  ...
  '.hp-social a { color:#fff; font-size:12px; letter-spacing:2px; text-decoration:none; font-family:"DM Mono",monospace; }',
  /* Pillar pages */
...
CMS.registerPreviewStyle(
  'data:text/css;base64,' + btoa(unescape(encodeURIComponent(BASE_CSS))),
  { raw: true }
);
